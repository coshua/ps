<h2><a href="https://leetcode.com/problems/ternary-expression-parser/?envType=company&envId=snapchat&favoriteSlug=snapchat-all">439. Ternary Expression Parser</a></h2><h3>Medium</h3><hr><p>Given a string <code>expression</code> representing arbitrarily nested ternary expressions, evaluate the expression, and return <em>the result of it</em>.</p>
